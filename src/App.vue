            ...
            <div class="flex items-center justify-between">
                <div class="menu-left">
                    <a href="#" class="text-xl">
						<img src="@/assets/logo.png" alt="" class="w-60">
					</a>
                </div>
                ...
                <div class="menu-center flex space-x-12" v-if="userStore.user.isAuthenticated">
                    ...
                    <RouterLink :to="{'name': 'notification'}">
                        ...
                        <div class="relative" v-if="notifs.length !== 0">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M14.857 17.082a23.848 23.848 0 005.454-1.31A8.967 8.967 0 0118 9.75v-.7V9A6 6 0 006 9v.75a8.967 8.967 0 01-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 01-5.714 0m5.714 0a3 3 0 11-5.714 0"></path>
                            </svg> 
                            <span class="absolute -top-2 -right-2 inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-red-100 bg-purple-600 rounded-full">
                                {{ notifs }}
                            </span>
                        </div>
